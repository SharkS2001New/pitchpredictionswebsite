...
function createStructuredData(siteUrl, currentDate) {
    ...
    const pageUrl = `${siteUrl}/football-predictions-today/predictions-under-over`;
    ...
    return {
        ...
        "@graph": [
            ...
            // 2. WebPage (OVER/UNDER PAGE)
            {
                "@type": "WebPage",
                "@id": `${pageUrl}#webpage`,
                "name": "Over/Under 2.5 Goals Predictions Today",
                "description": "Today's Over/Under 2.5 goals predictions with expert analysis. Get accurate football tips for over 2.5 and under 2.5 goals across top leagues.",
                "url": pageUrl,
                "isPartOf": {
                    "@type": "WebSite",
                    "@id": `${siteUrl}#website`
                ...
                "about": {
                    "@type": "Thing",
                    "name": "Over Under 2.5 Goals Football Predictions"
                },
                ...
                "breadcrumb": {
                    ...
                    "itemListElement": [
                        ...
                        },
                        {
                            "@type": "ListItem",
                            "position": 3,
                            "name": "Over/Under 2.5 Predictions",
                            "item": pageUrl
                        }
                    ]
                }
            ...
            // 3. FAQPage (Over/Under focused)
            {
                ...
                "mainEntity": [
                    {
                        "@type": "Question",
                        "name": "What is Over/Under 2.5 in football betting?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Over/Under 2.5 predicts whether the total goals in a match will be over or under 2.5. Over 2.5 means 3 or more goals, while under 2.5 means 2 or fewer goals."
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "Are over 2.5 predictions for today free?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Yes. All over and under 2.5 predictions are provided free, with premium picks offering higher-confidence selections."
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "How accurate are over/under predictions?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Over/under predictions are based on goal averages, attacking and defensive strength, recent form, and historical match data."
                        }
                    },
                    {
                        "@type": "Question",
                        "name": "Which leagues are covered in over/under predictions today?",
                        "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "Predictions cover top leagues including Premier League, La Liga, Serie A, Bundesliga, Champions League, and African competitions."
                        }
                    }
                ]
            },
            ...
            // 5. ItemList
            {
                "@type": "ItemList",
                "@id": `${pageUrl}#itemlist`,
                "name": "Over/Under 2.5 Predictions Today",
                "description": "Today's over and under 2.5 goals predictions across major football leagues.",
                "url": pageUrl,
                "numberOfItems": 20,
