// pages/team/[team-details]/players.js (or wherever this component is)
...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    // 🚀 Fetch last 6 matches in parallel
    const [last6Res] = await Promise.allSettled([
      // Last 6 matches
...
function Teams({ 
  ...
  const hasError = last6Status === "error" && !hasGeneralMatches;
