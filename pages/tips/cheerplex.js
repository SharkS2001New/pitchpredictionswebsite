...
export async function getServerSideProps() {
    ...
    try {
        ...
        if (data.status === true) {
            ...
            if (data.data && data.data.length > 20) {
                try {
                    ...
                    console.error('Error fetching full batch for cheerplex predictions:', batchError);
            ...
            return {
                props: {
                    ...
                    error: data.message || "Failed to load cheerplex predictions",
                    baseUrl: baseUrl,
                    todaysDate: todaysDate
                }
            };
        ...
        console.error('Error fetching cheerplex predictions:', error);
