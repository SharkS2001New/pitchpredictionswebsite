// pages/correct-score-predictions.js
...
import CorrectScorePredictionsContent from "../../components/seo-content/tips/correct-score";

function CorrectScorePredictions({ 
    initialData, 
    endpointStatus, 
    error,
    baseUrl,
    ...
    if (renderPredictions.length === 0) {
        return (
            <div className="sites-card">
                <DataNotFoundPage props={`No correct score predictions available for ${formatDisplayDate(todaysDate)}`}/>
                <br/>
                <Adsense
                    client="ca-pub-5665711413000284"
                    slot="3850951453"
        ...
        <div className="sites-card">
            ...
            <div className="">
                <div className="container">
                    <CorrectScorePredictionsContent/>
                </div>
            </div>
        </div>
    );
        ...
        if (data.status === true) {
            ...
            if (data.data && data.data.length > 20) {
                try {
                    ...
                    console.error('Error fetching full batch for correct score predictions:', batchError);
            ...
            return {
                props: {
                    ...
                    error: data.message || "Failed to load correct score predictions",
                    baseUrl: baseUrl,
                    todaysDate: todaysDate
                }
            };
...
export default CorrectScorePredictions;