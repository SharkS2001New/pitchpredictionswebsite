                ...
                <React.Fragment>
                    ...
                    <React.Fragment>
                        <div className="sites-card mb-2">
                         ...
                         <div className="sites-card">
                            <FetchUpcomingMatches home_team={match_details_data.home_team_name} away_team={match_details_data.away_team_name} home_team_id={match_details_data.home_team_id}
                                away_team_id ={match_details_data.away_team_id} fixture_date = { match_details_data.unformated_date } isMobile={isMobile}/>     
                        </div>               
                    </React.Fragment>
                    : <></>
                    }
