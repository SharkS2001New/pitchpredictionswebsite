...
function JackpotByNamePredictions(){    
    ...
    var renderPredictions = PagesMatchPredictionDetails("https://api.pitchpredictions.com/api/fetch_jackpot_fixtures_by_name?jackpot_name="+jackpot_name);
