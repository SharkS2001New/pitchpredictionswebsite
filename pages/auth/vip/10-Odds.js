          ...
          <React.Fragment>
            <nav aria-label="breadcrumb" className="mb-3 border-bottom">
              ...
              <div className="col-md-12 align-self-center p-static order-2 text-center">
                <h3 className="font-weight-bold text-dark">10 Odd</h3>
              </div>
            </nav>
                            ...
                            {yesterdaysMatches.length > 0 ? (
                              yesterdaysMatches.map((match, index) => (
                                <tr key={index}>
                                  ...
                                  <td style={{textAlign: "left"}}>{match.home_team} <span style={{ fontWeight: "bold" }}>&nbsp;vs&nbsp;</span> {match.away_team}</td>
...
export default withAuth(Vip10OddsGames);
