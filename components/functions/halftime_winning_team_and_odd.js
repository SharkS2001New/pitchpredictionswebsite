function HalfTimeWinningTeamAndOdd(hometeamodd,drawodd,awayteamodd,game_details){
    let winning_team = "";
    let winning_odd = 0;

    var hf_winning_preds_array = [];
    ...
    let winnig_odd_away  = game_details.bets_away;
     ...
     if(hometeamodd > drawodd && hometeamodd > awayteamodd)
     {
         ...
         hf_winning_preds_array.push(winning_team,winning_odd);
     ...
     return hf_winning_preds_array;
}

export default HalfTimeWinningTeamAndOdd;