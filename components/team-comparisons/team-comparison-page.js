...
function TeamComparisonDataPage(props){    
    ...
    if(team_matches.length>0){
        {team_matches.slice(0, teamMatchesNum).map((hometeam_d,l) => (          
            team_matches_array.push(
                <div className="responsive-row fixturesTextSize" key={l} style={{cursor : "auto"}}>
                    ...
                    <div className="responsive-cell team-link-namel" style={{textAlign: "left"}}>
                ...
                <div className="row">
                    ...
                    {/* <!-- Scroll Nav --> */}
                        ...
                        <div className="responsive-row header matchdetailsheader" style={{cursor : "auto"}}>
                            ...
                            <div className="responsive-cell team-link-namel" style={{textAlign: "left"}}>Match</div>
...
export default TeamComparisonDataPage;